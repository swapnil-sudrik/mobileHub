...
import { BudgetPhones } from '../services/budgetPhones';
import { Link } from 'react-router-dom';
import { IndianRupee } from 'lucide-react';

const BudgetPhonesView = () => {

    const [layout, setLayout] = useState('grid');
    const [products, setProducts] = useState([]);
    useEffect(() => {
        BudgetPhones.getBudgetIphones().then((data) => setProducts(data));
    }, []);
...
export default BudgetPhonesView;
